...
const Vector2D<float> PLATFORM_1_START_POSITION(1, SCREEN_HEIGHT/2 - PLATFORM_DESTINATION_WIDTH);
const Vector2D<float> PLATFORM_2_START_POSITION(700, SCREEN_HEIGHT/2 - PLATFORM_DESTINATION_WIDTH);
